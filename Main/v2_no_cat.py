...
# from Tools.Dedicated_Tools.telegram_gui import telegram_send_message
...
print("on tools")  # noqa
from Actions.execute_action import type_text, press_key, open_app, volume_control, news_update, wether_app, use_shortcut, set_alarm, set_timer, translate, clipboard, wait, done
